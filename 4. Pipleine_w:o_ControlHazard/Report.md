...
> Ripes에서 실행 한 single cycle cpu의 cycle은 0 cycle부터 시작함을 고려하여 52 cycle이었다. 본 과제에서 구현한 cycle의 경우 56 cycle로 ideal한 pipelined forwarding cpu와 single cycle cpu의 cycle 차가 4 cycle임을 보았을 때, 적합하게 구현되었음을 알 수 있었다.<br>
